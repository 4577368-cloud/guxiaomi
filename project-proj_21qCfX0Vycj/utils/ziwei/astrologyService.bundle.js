var ZiweiAstrology = (() => {
              ...
              if (y >= startYear) {
                ...
                if (solarTime.getYear() >= baseYear) {
                  ...
                  for (var i = 0, j = hours.length; i < j; i++) {
                    ...
                    var dgz = sect === 2 ? lunar.getDayInGanZhiExact2() : lunar.getDayInGanZhiExact();
          ...
          var _new = function(year, month, day, hour, minute, second, solar, ly) {
            ...
            return {
              ...
              getDayPositionFu: function(sect) {
                return (sect === 1 ? LunarUtil.POSITION_FU : LunarUtil.POSITION_FU_2)[this._p.dayGanIndex + 1];
              },
              ...
              getTimePositionFu: function(sect) {
                return (sect === 1 ? LunarUtil.POSITION_FU : LunarUtil.POSITION_FU_2)[this._p.timeGanIndex + 1];
              },
          ...
          var _fromYear = function(lunarYear) {
            ...
            return {
              ...
              getPositionFu: function(sect) {
                return (sect === 1 ? LunarUtil.POSITION_FU : LunarUtil.POSITION_FU_2)[this._p.ganIndex + 1];
              },
        ...
        var LunarMonth = function() {
          ...
          var _new = function(lunarYear, lunarMonth, dayCount, firstJulianDay, index) {
            return {
              ...
              getPositionFu: function(sect) {
                return (sect === 1 ? LunarUtil.POSITION_FU : LunarUtil.POSITION_FU_2)[this.getGanIndex() + 1];
              },
              getPositionFuDesc: function(sect) {
          ...
          var _fromLunar = function(lunar) {
            return {
              ...
              getTaiXi: function() {
                ...
                var ganIndex = this._p.sect === 2 ? lunar2.getDayGanIndexExact2() : lunar2.getDayGanIndexExact();
                var zhiIndex = this._p.sect === 2 ? lunar2.getDayZhiIndexExact2() : lunar2.getDayZhiIndexExact();
  ...
  var require_lunar_javascript = __commonJS({
    "node_modules/lunar-javascript/index.js"(exports, module) {
      var { Solar: Solar2, Lunar: Lunar2, Foto, Tao, NineStar, EightChar, SolarWeek, SolarMonth, SolarSeason, SolarHalfYear, SolarYear, LunarMonth, LunarYear, LunarTime, ShouXingUtil, SolarUtil, LunarUtil, FotoUtil, TaoUtil, HolidayUtil, NineStarUtil, I18n } = require_lunar();
      module.exports = {
        Solar: Solar2,
        Lunar: Lunar2,
        Foto,
  ...
  // ziwei/services/astrologyService.ts
  var astrologyService_exports = {};
  __export(astrologyService_exports, {
    calculateChart: () => calculateChart,
    calculateDaXianAnalysis: () => calculateDaXianAnalysis
  });
  ...
  var SI_HUA_PALACE_MEANINGS = {
    "\u547D\u5BAB": { "\u7984": "\u4EBA\u7F18\u597D\uFF0C\u798F\u6C14\u539A", "\u6743": "\u81EA\u4FE1\u5F3A\uFF0C\u9886\u5BFC\u529B", "\u79D1": "\u540D\u58F0\u4F73\uFF0C\u8D35\u4EBA\u52A9", "\u5FCC": "\u81EA\u6211\u7EA0\u7ED3\uFF0C\u4F53\u5F31" },
    "\u5144\u5F1F": { "\u7984": "\u5144\u5F1F\u52A9\u8D22", "\u6743": "\u5144\u5F1F\u7ADE\u4E89", "\u79D1": "\u5144\u5F1F\u548C\u7766", "\u5FCC": "\u5144\u5F1F\u7F18\u8584\uFF0C\u8FDE\u7D2F" },
    "\u592B\u59BB": { "\u7984": "\u914D\u5076\u5BCC\u88D5", "\u6743": "\u914D\u5076\u5F3A\u52BF", "\u79D1": "\u5A5A\u59FB\u548C\u8C10", "\u5FCC": "\u611F\u60C5\u7834\u88C2\uFF0C\u914D\u5076\u75C5" },
    "\u5B50\u5973": { "\u7984": "\u5B50\u5973\u6709\u798F", "\u6743": "\u5B50\u5973\u53DB\u9006", "\u79D1": "\u5B50\u5973\u806A\u660E", "\u5FCC": "\u5B50\u5973\u96BE\u517B\uFF0C\u6559\u80B2\u96BE" },
    "\u8D22\u5E1B": { "\u7984": "\u8D22\u6E90\u5E7F\u8FDB", "\u6743": "\u638C\u8D22\u6743", "\u79D1": "\u7406\u8D22\u6709\u540D", "\u5FCC": "\u7834\u8D22\uFF0C\u503A\u52A1" },
    "\u75BE\u5384": { "\u7984": "\u5C11\u75C5", "\u6743": "\u6025\u75C7", "\u79D1": "\u75C5\u6613\u6108", "\u5FCC": "\u6162\u6027\u75C5\uFF0C\u624B\u672F" },
    "\u8FC1\u79FB": { "\u7984": "\u5916\u5730\u5F97\u8D22", "\u6743": "\u5916\u51FA\u638C\u6743", "\u79D1": "\u51FA\u5916\u8D35\u4EBA", "\u5FCC": "\u5916\u51FA\u707E\u7978" },
    "\u4EA4\u53CB": { "\u7984": "\u670B\u53CB\u52A9\u8D22", "\u6743": "\u670B\u53CB\u7ADE\u4E89", "\u79D1": "\u670B\u53CB\u6587\u96C5", "\u5FCC": "\u670B\u53CB\u80CC\u53DB" },
    "\u5B98\u7984": { "\u7984": "\u4E8B\u4E1A\u987A\u5229", "\u6743": "\u804C\u4F4D\u9AD8", "\u79D1": "\u540D\u58F0\u597D", "\u5FCC": "\u4E8B\u4E1A\u53D7\u963B" },
    "\u7530\u5B85": { "\u7984": "\u623F\u4EA7\u589E\u503C", "\u6743": "\u638C\u5BB6\u6743", "\u79D1": "\u5BB6\u5B85\u5B89\u5B81", "\u5FCC": "\u623F\u4EA7\u7EA0\u7EB7" },
    "\u798F\u5FB7": { "\u7984": "\u5FC3\u5B89\u4EAB\u4E50", "\u6743": "\u5185\u5FC3\u5F3A\u52BF", "\u79D1": "\u7CBE\u795E\u6109\u60A6", "\u5FCC": "\u7126\u8651\u6291\u90C1" },
    "\u7236\u6BCD": { "\u7984": "\u7236\u6BCD\u6709\u798F", "\u6743": "\u7236\u6BCD\u7BA1\u6559\u4E25", "\u79D1": "\u7236\u6BCD\u6587\u96C5", "\u5FCC": "\u7236\u6BCD\u75C5\u707E" }
  };

  // ziwei/data/interpretation.ts
  var INTERPRETATION_TEMPLATES = {
    CORE_TRAIT: {
      MAJOR: `
...
\u3010\u53D1\u5C55\u7B56\u7565\u3011\u9002\u5408\u91C7\u7528\${strategy}\u65B9\u5F0F\u63A8\u8FDB\uFF0C\u5FCC\u8D2A\u5FEB\u6C42\u5168\u3002\u957F\u671F\u6765\u770B\uFF0C\${longTermOutlook}\u3002
    ...
    INTERACTION: {
      ...
      JIA: "\u{1F91D} **\u5DE6\u53F3\u5939\u8F85**\uFF1A\u672C\u5BAB\u53D7\u5230\u5DE6\u53F3\u4E24\u5BAB\uFF08${prev}\u3001${next}\uFF09\u7684\u3010${stars}\u3011\u5939\u8F85\uFF0C\u5F62\u6210\u4E86\u201C${type}\u201D\u7684\u7ED3\u6784\uFF0C${effect}\u3002",
      SAN_FANG: "\u267B\uFE0F **\u4E09\u65B9\u6C47\u805A**\uFF1A\u4E09\u65B9\u56DB\u6B63\u62F1\u7167\uFF0C\u6C47\u805A\u4E86\u5409\u661F\u3010${luckyStars}\u3011\u4E0E\u715E\u661F\u3010${badStars}\u3011\u3002<br/>${analysis}"
    },
    RISK_CATEGORY: {
      FINANCIAL: "\u{1F4B8} **\u8D22\u52A1\u98CE\u9669**\uFF1A\u672C\u5BAB\u53D7\u3010${stars}\u3011\u5F71\u54CD\uFF0C\u5BB9\u6613\u51FA\u73B0\u8D44\u91D1\u6D41\u5931\u3001\u51B2\u52A8\u6D88\u8D39\u6216\u6295\u8D44\u5931\u8BEF\uFF0C\u5EFA\u8BAE\u8BE5\u9886\u57DF\u4FDD\u5B88\u7406\u8D22\u3002",
      PHYSICAL: "\u{1F691} **\u5065\u5EB7/\u5211\u4F24**\uFF1A\u89C1\u3010${stars}\u3011\u7B49\u661F\u66DC\uFF0C\u9700\u6CE8\u610F\u8EAB\u4F53\u635F\u4F24\u3001\u610F\u5916\u78D5\u78B0\u6216\u624B\u672F\u98CE\u9669\uFF0C\u884C\u4E8B\u5B9C\u7F13\u3002",
      EMOTIONAL: "\u{1F92F} **\u7CBE\u795E\u5185\u8017**\uFF1A\u53D7\u3010${stars}\u3011\u5E72\u6270\uFF0C\u5BB9\u6613\u9677\u5165\u7126\u8651\u3001\u7EA0\u7ED3\u6216\u5B64\u72EC\u611F\u4E2D\uFF0C\u5EFA\u8BAE\u591A\u8FDB\u884C\u5FC3\u7406\u8C03\u8282\u3002",
      CONFLICT: "\u{1F92C} **\u53E3\u820C\u662F\u975E**\uFF1A\u3010${stars}\u3011\u4E91\u96C6\uFF0C\u5BB9\u6613\u62DB\u60F9\u5C0F\u4EBA\u8BFD\u8C24\u6216\u6CD5\u5F8B\u7EA0\u7EB7\uFF0C\u7B7E\u7F72\u6587\u4EF6\u6216\u53D1\u8868\u8A00\u8BBA\u9700\u683C\u5916\u8C28\u614E\u3002"
    },
    AGE_CONTEXT: {
  ...
  var getBureau = (ganIndex, zhiIndex) => {
  ...
  var arrangeMainStarsComplete = (lunarDay, bureauNum, palaces) => {
    const D = lunarDay;
    const B = bureauNum;
    let X = 0;
    if (D % B === 0) {
    ...
    zwStars.forEach((star, idx) => {
      ...
      if (palace) {
        const brightness = EXTENDED_STAR_BRIGHTNESS[star] ? EXTENDED_STAR_BRIGHTNESS[star][pos] : void 0;
  ...
  var arrangeGanStars = (yearGan, yearGanIndex, palaces) => {
    const results = [];
  ...
  var arrangeYearBranchStars = (yearZhiIndex, hourIndex, palaces) => {
    const results = [];
    let maPos = 0;
    if ([8, 0, 4].includes(yearZhiIndex))
      maPos = 2;
    else if ([2, 6, 10].includes(yearZhiIndex))
      maPos = 8;
    else if ([11, 3, 7].includes(yearZhiIndex))
      maPos = 5;
    else if ([5, 9, 1].includes(yearZhiIndex))
      maPos = 11;
    results.push({ palace: palaces[maPos], star: "\u5929\u9A6C", type: "movement" });
    let huoStart = 0;
    let lingStart = 0;
    if ([2, 6, 10].includes(yearZhiIndex)) {
      huoStart = 1;
      lingStart = 3;
    } else if ([8, 0, 4].includes(yearZhiIndex)) {
      huoStart = 2;
      lingStart = 10;
    } else if ([5, 9, 1].includes(yearZhiIndex)) {
      huoStart = 3;
    ...
    if ([11, 0, 1].includes(yearZhiIndex)) {
      guPos = 2;
      guaPos = 10;
    } else if ([2, 3, 4].includes(yearZhiIndex)) {
      guPos = 5;
      guaPos = 1;
    } else if ([5, 6, 7].includes(yearZhiIndex)) {
      guPos = 8;
      guaPos = 4;
    } else if ([8, 9, 10].includes(yearZhiIndex)) {
      guPos = 11;
      guaPos = 7;
    }
  ...
  var arrangeMonthStars = (monthIndex, palaces) => {
    const results = [];
    ...
    if (tianYueMonthMap[monthIndex] !== void 0) {
  ...
  var arrangeDayStars = (dayIndex, palaces) => {
  ...
  var arrangeHourStars = (hourIndex, palaces) => {
    const results = [];
  ...
  var arrangeAdditionalStars = (yearZhiIndex, palaces) => {
    const results = [];
    const sanHeGroup = yearZhiIndex % 4;
    ...
    const poSuiPos = [3, 5, -1, 9, -1, 1, -1, 7, -1, 11, -1, 1][yearZhiIndex];
    if (poSuiPos !== -1)
      results.push({ palace: palaces[poSuiPos], star: "\u7834\u788E", type: "bad" });
    const feiLianPos = [8, 5, 2, 11, 8, 5, 2, 11, 8, 5, 2, 11][yearZhiIndex];
    results.push({ palace: palaces[feiLianPos], star: "\u871A\u5EC9", type: "bad" });
    return results.filter((r) => r.palace);
  };
  var arrangeFixedStars = (mingIndex, palaces) => {
    const results = [];
  ...
  var applyFourTransformationsComplete = (palaces, yearGan) => {
    const siHuaMap = SI_HUA_TABLE[yearGan] || {};
    palaces.forEach((palace) => {
      palace.stars.major.forEach((star) => {
        if (siHuaMap[star.name]) {
          star.hua = siHuaMap[star.name];
        }
      });
      palace.stars.minor.forEach((star) => {
        if (siHuaMap[star.name]) {
          star.hua = siHuaMap[star.name];
        }
      });
  ...
  var getSanFangSiZheng = (palaces, mingIndex) => {
    const idx = (offset) => (mingIndex + offset + 12) % 12;
    return [
      palaces[mingIndex],
      palaces[idx(4)],
      palaces[idx(8)],
  ...
  var SIMPLE_PATTERNS = [
    ...
    { id: "GE033", name: "\u6B66\u66F2\u8D22\u661F\u683C", type: "\u5409", level: 3, stars: ["\u6B66\u66F2"], desc: "\u7406\u8D22\u80FD\u529B\u5353\u8D8A\uFF0C\u7CBE\u4E8E\u5B9E\u4E1A\u4E0E\u8D44\u672C\u8FD0\u4F5C\uFF0C\u5B9C\u91D1\u878D\u3001\u4F1A\u8BA1\u3001\u5236\u9020\u4E1A\u3002\u5E99\u65FA\u65E0\u715E\uFF0C\u5BCC\u7532\u4E00\u65B9\u3002", condition: (c) => {
      const wealth = c.palaces.find((p) => p.name === "\u8D22\u5E1B");
    ...
    { id: "GE048", name: "\u89E3\u795E\u6551\u5384\u683C", type: "\u5409", level: 2, stars: ["\u89E3\u795E"], desc: "\u9022\u51F6\u5316\u5409\uFF0C\u5927\u96BE\u4E0D\u6B7B\uFF0C\u5177\u5929\u7136\u907F\u9669\u80FD\u529B\u3002\u5C24\u5176\u5728\u75BE\u5384\u6216\u7236\u6BCD\u5BAB\u89C1\u4E4B\uFF0C\u53EF\u89E3\u91CD\u707E\u3002", condition: (c) => {
      const health = c.palaces.find((p) => p.name === "\u75BE\u5384");
      const parents = c.palaces.find((p) => p.name === "\u7236\u6BCD");
    ...
    { id: "GE049", name: "\u5929\u6708\u5929\u4F24\u683C", type: "\u51F6", level: -2, stars: ["\u5929\u6708", "\u5929\u4F24"], desc: "\u6613\u56E0\u670B\u53CB\u5E26\u6765\u60C5\u7EEA\u56F0\u6270\u6216\u8D22\u52A1\u635F\u5931\uFF0C\u4EA4\u53CB\u9700\u8C28\u614E\u3002\u591A\u89C1\u4E8E\u4EA4\u53CB\u5BAB\u53D7\u51B2\u3002", condition: (c) => {
      const friends = c.palaces.find((p) => p.name === "\u4EA4\u53CB");
    ...
    { id: "GE057", name: "\u7EA2\u9E3E\u5929\u559C\u683C", type: "\u5409", level: 2, stars: ["\u7EA2\u9E3E", "\u5929\u559C"], desc: "\u5A5A\u604B\u559C\u5E86\u8FDE\u8FDE\uFF0C\u751F\u80B2\u987A\u5229\uFF0C\u611F\u60C5\u751F\u6D3B\u4E30\u5BCC\u3002\u592B\u59BB\u5BAB\u89C1\u4E4B\uFF0C\u5A5A\u59FB\u548C\u8C10\u7F8E\u6EE1\u3002", condition: (c) => {
      const spouse = c.palaces.find((p) => p.name === "\u592B\u59BB");
      if (!spouse)
        return false;
    ...
    { id: "GE062", name: "\u5929\u798F\u5929\u5BFF\u683C", type: "\u5409", level: 2, stars: ["\u5929\u798F", "\u5929\u5BFF"], desc: "\u798F\u5BFF\u7EF5\u957F\uFF0C\u665A\u5E74\u5B89\u9038\u65E0\u5FE7\u3002\u798F\u5FB7\u5BAB\u89C1\u4E4B\uFF0C\u8EAB\u5FC3\u5EB7\u6CF0\uFF0C\u5C11\u75C5\u5C11\u707E\u3002", condition: (c) => {
      const fortune = c.palaces.find((p) => p.name === "\u798F\u5FB7");
  ...
  var COMPLEX_PATTERNS = [
    {
      ...
      check: (c) => c.sanFangSiZheng.some((p) => {
    ...
    },
    {
      ...
      check: (c) => {
        const hasLu = c.sanFangSiZheng.some((p) => {
          const s = getStarNames(p);
          return s.has("\u7984\u5B58") || hasSiHua(p, "\u7984");
        });
        const hasMa = c.sanFangSiZheng.some((p) => getStarNames(p).has("\u5929\u9A6C"));
        return hasLu && hasMa;
      }
    },
    {
      ...
      check: (c) => {
        if (!c.mingStars.has("\u7D2B\u5FAE"))
          return false;
        const luckies = ["\u5DE6\u8F85", "\u53F3\u5F3C", "\u6587\u660C", "\u6587\u66F2", "\u5929\u9B41", "\u5929\u94BA"];
        let count = 0;
        c.sanFangSiZheng.forEach((p) => {
          const s = getStarNames(p);
    ...
    },
    {
      ...
      check: (c) => {
        const hasSha = c.sanFangSiZheng.some((p) => getStarNames(p).has("\u4E03\u6740"));
        const hasPo = c.sanFangSiZheng.some((p) => getStarNames(p).has("\u7834\u519B"));
        const hasLang = c.sanFangSiZheng.some((p) => getStarNames(p).has("\u8D2A\u72FC"));
    ...
    },
    {
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u6587\u660C") && c.nextStars.has("\u6587\u66F2") || c.prevStars.has("\u6587\u66F2") && c.nextStars.has("\u6587\u660C"))
    },
    {
      id: "GE007",
      name: "\u5DE6\u53F3\u5939\u547D\u683C",
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u5DE6\u8F85") && c.nextStars.has("\u53F3\u5F3C") || c.prevStars.has("\u53F3\u5F3C") && c.nextStars.has("\u5DE6\u8F85"))
    },
    {
      id: "GE008",
      name: "\u9B41\u94BA\u5939\u547D\u683C",
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u5929\u9B41") && c.nextStars.has("\u5929\u94BA") || c.prevStars.has("\u5929\u94BA") && c.nextStars.has("\u5929\u9B41"))
    },
    {
      id: "GE009",
      name: "\u65E5\u6708\u5E76\u660E\u683C",
      ...
      check: (c) => c.mingStars.has("\u592A\u9633") && c.mingStars.has("\u592A\u9634") && (c.ming.zhi === "\u4E11" || c.ming.zhi === "\u672A")
    },
    {
      id: "GE010",
      name: "\u65E5\u7167\u96F7\u95E8\u683C",
      ...
      check: (c) => c.mingStars.has("\u592A\u9633") && c.ming.zhi === "\u5348"
    },
    {
      id: "GE011",
      name: "\u660E\u73E0\u51FA\u6D77\u683C",
      ...
      check: (c) => c.mingStars.has("\u592A\u9633") && c.ming.zhi === "\u536F"
    },
    {
      id: "GE012",
      name: "\u6708\u6717\u5929\u95E8\u683C",
      ...
      check: (c) => c.mingStars.has("\u592A\u9634") && c.ming.zhi === "\u4EA5"
    },
    {
      id: "GE013",
      name: "\u6781\u5411\u79BB\u660E\u683C",
      ...
      check: (c) => c.mingStars.has("\u7D2B\u5FAE") && c.ming.zhi === "\u5348"
    },
    {
      id: "GE014",
      name: "\u77F3\u4E2D\u9690\u7389\u683C",
      ...
      check: (c) => c.ming.stars.major.length === 0 && getStarNames(c.travel).has("\u7D2B\u5FAE") && getStarNames(c.travel).has("\u5929\u5E9C")
    },
    {
      id: "GE015",
      name: "\u673A\u6708\u540C\u6881\u683C",
    ...
    },
    {
      ...
      check: (c) => c.mingStars.has("\u5EC9\u8D1E") && c.mingStars.has("\u8D2A\u72FC") && (c.ming.zhi === "\u5BC5" || c.ming.zhi === "\u7533")
    },
    {
      id: "GE017",
      name: "\u5DE8\u65E5\u683C",
      ...
      check: (c) => c.mingStars.has("\u5DE8\u95E8") && c.mingStars.has("\u592A\u9633") && c.ming.zhi === "\u5BC5"
    },
    {
      id: "GE018",
      name: "\u5929\u6881\u836B\u661F\u683C",
      ...
      check: (c) => (c.mingStars.has("\u5929\u6881") || getStarNames(c.travel).has("\u5929\u6881")) && (c.mingStars.has("\u5929\u9B41") || c.mingStars.has("\u5929\u94BA"))
    },
    {
      id: "GE019",
      name: "\u5211\u56DA\u5939\u5370\u683C",
    ...
    },
    {
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u64CE\u7F8A") && c.nextStars.has("\u9640\u7F57") || c.prevStars.has("\u9640\u7F57") && c.nextStars.has("\u64CE\u7F8A"))
    },
    {
      id: "GE021",
      name: "\u706B\u94C3\u5939\u547D\u683C",
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u706B\u661F") && c.nextStars.has("\u94C3\u661F") || c.prevStars.has("\u94C3\u661F") && c.nextStars.has("\u706B\u661F"))
    },
    {
      id: "GE022",
      name: "\u7A7A\u52AB\u5939\u547D\u683C",
      ...
      check: (c) => ["\u5B50", "\u5348", "\u536F", "\u9149"].includes(c.ming.zhi) && (c.prevStars.has("\u5730\u7A7A") && c.nextStars.has("\u5730\u52AB") || c.prevStars.has("\u5730\u52AB") && c.nextStars.has("\u5730\u7A7A"))
    },
    {
      id: "GE023",
      name: "\u5B64\u8FB0\u5BE1\u5BBF\u683C",
      ...
      check: (c) => c.mingStars.has("\u5B64\u8FB0") && c.mingStars.has("\u5BE1\u5BBF")
    },
    {
      id: "GE024",
      name: "\u622A\u7A7A\u65EC\u7A7A\u683C",
      ...
      check: (c) => c.mingStars.has("\u622A\u7A7A") && c.mingStars.has("\u65EC\u7A7A") || getStarNames(c.palaces.find((p) => p.name === "\u8D22\u5E1B")).has("\u622A\u7A7A") && getStarNames(c.palaces.find((p) => p.name === "\u8D22\u5E1B")).has("\u65EC\u7A7A")
    },
    {
      id: "GE025",
      name: "\u9A6C\u5934\u5E26\u5251\u683C",
      ...
      check: (c) => c.mingStars.has("\u64CE\u7F8A") && c.ming.zhi === "\u5348"
    },
    {
      id: "GE026",
      name: "\u6C34\u706B\u65E2\u6D4E\u683C",
      ...
      check: (c) => {
        const prop = c.palaces.find((p) => p.name === "\u7530\u5B85");
        if (!prop)
          return false;
    ...
    },
    {
      ...
      check: (c) => c.ming.stars.major.length === 0
    },
    {
      id: "GE044",
      name: "\u9634\u9633\u53CD\u80CC\u683C",
      ...
      check: (c) => c.mingStars.has("\u592A\u9633") && c.mingStars.has("\u592A\u9634") && (c.ming.zhi === "\u8FB0" || c.ming.zhi === "\u620C")
    },
    {
      id: "GE051",
      name: "\u7984\u7167\u8D22\u5E1B\u683C",
      ...
      check: (c) => {
        const w = c.palaces.find((p) => p.name === "\u8D22\u5E1B");
    ...
    },
    {
      ...
      check: (c) => {
        const car = c.palaces.find((p) => p.name === "\u5B98\u7984");
    ...
    },
    {
      ...
      check: (c) => hasSiHua(c.ming, "\u79D1") || hasSiHua(c.travel, "\u79D1")
    },
    {
      id: "GE054",
      name: "\u5FCC\u5165\u592B\u59BB\u683C",
      ...
      check: (c) => {
        const s = c.palaces.find((p) => p.name === "\u592B\u59BB");
    ...
    },
    {
      ...
      check: (c) => hasSiHua(c.ming, "\u7984") && hasSiHua(c.ming, "\u5FCC")
    }
  ];
  var calculatePatterns = (palaces, mingIndex, yearGan) => {
  ...
  var calculateChart = (year, month, day, hour, gender, lng) => {
    try {
      ...
      const solar = import_lunar_javascript.Solar.fromDate(baseDate);
      ...
      for (let i = 0; i < 12; i++) {
        ...
        if (i === 0)
          palaces[palaceIndex].isMing = true;
      }
      ...
      const mingGanIndex = HEAVENLY_STEMS.indexOf(mingPalace.stem);
      ...
      placementSteps.forEach((step) => {
        ...
        newStars.forEach((item) => {
          ...
          if (!existing) {
            const brightness = EXTENDED_STAR_BRIGHTNESS[item.star] ? EXTENDED_STAR_BRIGHTNESS[item.star][item.palace.zhiIndex] : void 0;
      ...
      if (bureau.type === "Wood")
        csStart = 11;
      else if (bureau.type === "Fire")
        csStart = 2;
      else if (bureau.type === "Gold")
        csStart = 5;
      for (let i = 0; i < 12; i++) {
        ...
        if (pIdx !== -1)
          palaces[pIdx].changSheng = CHANG_SHENG[i];
      }
      ...
      for (let i = 0; i < 12; i++) {
        ...
        const pIdx = palaces.findIndex((p) => p.zhiIndex === idx);
        if (pIdx !== -1)
          palaces[pIdx].daXian = `${daXianStartAge}-${endAge}`;
        daXianStartAge += 10;
      }
  ...
  var calculateDaXianAnalysis = (palaces, currentYearGan, currentAge) => {
    const mingPalace = palaces.find((p) => p.name === "\u547D\u5BAB");
    if (!mingPalace)
      return null;
    const result = { daXianAnalysis: [], currentDaXian: null };
    const parseDaXianRange = (rangeStr) => {
      if (!rangeStr)
  ...
  return __toCommonJS(astrologyService_exports);
})();
